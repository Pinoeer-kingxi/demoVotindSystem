...
import avatar from "../assets/image/img_vote1.png";
import avatar1 from "../assets/image/img_vote1.png";
...
const todo: ToDo[] = [
  {
    isFinished: false,
    content: "2023年陕西师范大学寝室文化节",
  },
  {
    isFinished: false,
    content: "2023年陕西师范大学荧光夜跑",
  },
  {
    isFinished: false,
    content: "第二届“卓越之言杯”陕西省校园经典诵读大赛",
  },
  {
    isFinished: false,
    content: "2023年陕西师范大学ACM-ICPC校赛",
  },
  {
    isFinished: false,
    content: "“红烛杯”第十四届师范生教育教学能力大赛",
  },
  {
    isFinished: false,
    content: "睡个好觉，明天好好努力",
